...
class SensitiveFilesScanner(BaseScanner):
    def __init__(self, target: str, session=None, post_data: dict = None):
        ...
        self.files = {
            ...
            '.gitignore': [r'vendor/', r'node_modules/', r'.env'],
            'docker-compose.yml': [r'services:', r'image:', r'ports:'],
            'Makefile': [r'^[a-zA-Z_]+:', r'install:', r'test:'],
        }
    ...
    def scan(self) -> Finding:
        ...
        try:
                        ...
                        if is_sensitive:
                            ...
                            finding.add_evidence(
                                self._evidence_builder.verified(
                                    f"File {file} exists (no sensitive content)",
                                    payload=test_url
                                )
                            )
                except Exception:
            ...
            if exposed_files:
                ...
                for ef in exposed_files[:3]:
                    finding.add_recommendation(
                        ...
                        f"This file contains sensitive information that could be used by attackers.",
            ...
            finding.add_evidence(
                self._evidence_builder.error(f"Error scanning sensitive files: {str(e)}", payload=None)
            )
